...
# 大樂透 2019.02.04
# 一：1 主程式 lottery_v2 檔 點右鍵選 Edit with IDLE 編輯
#     2 自動執行 如下
# 二：run_01_A0.bat run_01_B0.bat run_01_C0.bat run_01_D0.bat run_01_E0.bat 自動運行 ( 例示如下 ) 
# c:\Python27\python.exe lottery_v2.py 01 02 03
# c:\Python27\python.exe lottery_v2.py 01 02 04 .......
# c:\Python27\python.exe lottery_v2.py 47 48 49
# 三：500=60分()、400=40分()、300=17分(6500)、250=12分(4300)、200=7分(2300) 參考值
...
# 程式開始
# 指定檔名 ( 開獎資料檔 ) =====================
filename = 'run_10_Lottery_u01.txt'
# 連續出現次數 ================================
expected_counter = 6
# 間距 ========================================
index_max = 200
...
# 號碼
if len(sys.argv) != 4:
    dumpline = '輸入: c:\Python27\python.exe N1 N2 N3'
    print (dumpline)
    quit()
...
# 輸出名稱 ====== 3S1output_ =====================================
outputfilename = 'Lot3_output_' + N1 + '_' + N2 + '_' + N3 + '.txt'
