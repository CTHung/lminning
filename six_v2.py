...
# c:\Python27\python.exe six_v2.py 01 02 03
# c:\Python27\python.exe six_v2.py 01 02 04 .......
# c:\Python27\python.exe six_v2.py 47 48 49
...
# 號碼
if len(sys.argv) != 4:
    dumpline = '輸入: c:\Python27\python.exe six_v2.py N1 N2 N3'
    print (dumpline)
    N1 = '01'
    N2 = '02'
    N3= '03'
...
# 輸出名稱 ====== 3S1output_ =====================================
outputfilename = 'Six_output_' + N1 + '_' + N2 + '_' + N3 + '.txt'
